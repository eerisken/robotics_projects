...
import os
import time
from robot_helper import RobotHelper
...
from behavior_tree import create_root_behaviour, create_root_behaviour_pick_place
...
def run_robot_controller():
    ...
    root = create_root_behaviour_pick_place(robot, lidar, gps, compass, left_motor, right_motor, blackboard) 
